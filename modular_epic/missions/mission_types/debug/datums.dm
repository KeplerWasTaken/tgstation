/datum/mission/debug/New(name, difficulty, maptemplate, missiontype, description)
    . = ..("DEBUG-[rand(0,1000)]", rand(MISSION_DIFFICULTY_MINIMUM, MISSION_DIFFICULTY_MAXIMUM), /datum/lazy_template/mission, "Debug", "A mission for debugging purposes")
    
/datum/mission/debug/on_mission_loaded(datum/lazy_template/source, loaded_atom_movables, loaded_turfs, loaded_areas)
	. = ..()
