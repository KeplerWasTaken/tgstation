...
/obj/item/gun/energy/wiremod_gun
	...
	modular_initial_slots = list(/obj/item/stock_parts/power_store/cell/emproof/wiremod_gun)
	item_flags = NONE
...
/obj/item/circuit_component/wiremod_gun/proc/handle_chamber(atom/source)
	...
	var/transferred = fired_gun.cells_give_power(min(0.1 * STANDARD_CELL_CHARGE, parent.cells_get_charge()))
	if(transferred)
